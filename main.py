                        ...
                        while answer not in ('stop', 'стоп'):
                            try:
                                ...
                                user_selection = input(
                                    "Напиши all - для создания файла c выбранными вакансиями, напиши new - для "
                                    "добавления в файл новых вакансий или напиши stop - если вакансии \nне хочешь "
                                    "записывать в файл: "
                                ).lower().strip()
                                ...
                                answer = input(
                                    'Напиши stop - для завершения поиска или нажми Enter - для ввода другого количества вакансий: '
                                ).lower().strip()

                    except EmptyList as e:
                        print(e)
                        answer = input(
                            'Напиши stop - для завершения поиска или нажми Enter - для ввода другого диапазона зарплат: '
                        ).lower().strip()
            except EmptyList as e:
                print(e)
                answer = input(
                    'Напиши stop - для завершения поиска или нажми Enter - для ввода других ключевых слов: '
                ).lower().strip()
    except EmptyList as e:
        print(e)
